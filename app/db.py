...
from sqlalchemy import create_engine, String, Integer, DateTime, Text, Boolean, select, func
...
def audit(db, actor, action, target="", ip="", details=""): db.add(AuditLog(actor=actor, action=action, target=target, ip=ip, details=details))
